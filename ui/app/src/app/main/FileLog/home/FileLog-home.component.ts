...
@Component({
  selector: 'FileLog-home',
  templateUrl: './FileLog-home.component.html',
  styleUrls: ['./FileLog-home.component.scss']
})
export class FileLogHomeComponent implements AfterViewInit {
