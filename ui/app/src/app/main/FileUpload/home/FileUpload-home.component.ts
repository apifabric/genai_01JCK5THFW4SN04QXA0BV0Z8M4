...
@Component({
  selector: 'FileUpload-home',
  templateUrl: './FileUpload-home.component.html',
  styleUrls: ['./FileUpload-home.component.scss']
})
export class FileUploadHomeComponent implements AfterViewInit {
