...
@Component({
  selector: 'CpuLog-home',
  templateUrl: './CpuLog-home.component.html',
  styleUrls: ['./CpuLog-home.component.scss']
})
export class CpuLogHomeComponent implements AfterViewInit {
